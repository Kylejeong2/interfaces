...
The museum documents how people learned to interact with artificial intelligence. A strong contribution adds evidence to that history. It does more than add another AI product.
...
The pre-commit hook runs formatting and lint checks. If it fails, run `pnpm format`, review the resulting changes, and commit again.
